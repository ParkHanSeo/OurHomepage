...
public class MemberController {
	 ...
	 */
	@GetMapping("/log")
	public String memberAccessHistory(@RequestParam(defaultValue = "1") int cPage, Model model, HttpServletRequest request) throws Exception {		
		int limit = 20;
		// 접속 이력 리스트
	...
	/**
	 * User 단 테스트로인한 메소드
	 * 일시적으로 회원가입을 클릭하였을 때 해당 페이지로 이동
	 * @return
	 */
