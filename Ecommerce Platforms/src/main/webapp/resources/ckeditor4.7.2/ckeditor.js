        ...
        on: function (b, d, g, h, k) {
          ...
          if (0 > f.getListenerIndex(d)) {
            ...
            for (var w = f.length - 1; 0 <= w; w--)
              if (f[w].priority <= k)
                return f.splice(w + 1, 0, n), { removeListener: u };
            f.unshift(n);
          }
    ...
    CKEDITOR.tools = {
      ...
      enableHtml5Elements: function (a, b) {
        for (
          ...
          (d = a.createElement(c[k])), b && a.appendChild(d);
      },
            ...
            ? f.type == CKEDITOR.NODE_ELEMENT &&
              (f =
                0 < D
                  ...
                  : !1 === g(f, !0)
                  ? null
                  : f.getPreviousSourceNode(!0, t, g))
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === g(d, !0) ? null : d.getNextSourceNode(!0, t, g)))),
          f && !1 === g(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
  ...
  (function () {
    ...
    function d(a, b, c, d, e) {
      ...
      if (
        ...
        (t.equals(J) ||
          (t.type === CKEDITOR.NODE_ELEMENT && t.getFirst().equals(J)))
      )
        ...
        for (
          ...
          V = Y.getNext();
          for (
            Q != r || (Y.equals(p[Q]) && r < G)
              ? b && (P = N.append(Y.clone(0, e)))
              : q
              ? g(Y, N, !1, v)
        ...
        N = c;
        for (Q = C; Q <= G; Q++)
          if (((c = p[Q]), (V = c.getPrevious()), c.equals(O[Q])))
            b && (N = N.getChild(0));
          else {
            Q != G || (c.equals(O[Q]) && G < r)
              ? b && (P = N.append(c.clone(0, e)))
              : y
              ? g(c, N, !1, B)
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            E.type == CKEDITOR.NODE_TEXT
              ? (y &&
                  ...
                  (H = !!E)),
                E && ((t = E.getPrevious()) || (l = E.getParent())))
              : (y && (t = E.getChild(y - 1) || E.getLast()), t || (l = E));
            for (l = c(l); l || t; ) {
              if (l && !t) {
                !J && l.equals(m) && (J = !0);
              ...
              for (; t; )
                if (((E = !1), t.type == CKEDITOR.NODE_COMMENT))
                  t = t.getPrevious();
                else {
                  if (t.type == CKEDITOR.NODE_TEXT)
                    ...
                    (t.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                      (b && t.is("br"))) &&
                    !t.data("cke-bookmark")
                  )
                    if (H && CKEDITOR.dtd.$removeEmpty[t.getName()]) {
                      q = t.getText();
                      if (d.test(q)) t = null;
                      else
                        for (
                          var y = t.$.getElementsByTagName("*"), v = 0, B;
                          (B = y[v++]);
            ...
            for (; l || t; ) {
              if (l && !t) {
                ...
                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                (H && "inline" == l.getComputedStyle("display")) ||
                  ((H = !1), J ? (u = l) : l && this.setEndAfter(l));
                t = l.getNext();
              }
              for (; t; ) {
                E = !1;
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
              l = this.clone();
              l = new CKEDITOR.dom.walker(l);
              var r = CKEDITOR.dom.walker.whitespaces(),
        ...
        for (this._.nextNode = null; m; ) {
          ...
          if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
            ...
            if (
              ...
              if ("br" == t) I = 1;
              else if (!h && !m.getChildCount() && "hr" != t) {
                d = m;
                w = m.equals(x);
                break;
              }
          ...
          !m.equals(h.root)
            ...
            : w ||
              (this._.nextNode = d.equals(x)
                ? null
                : this._getNextSourceNode(h.getBoundaryNodes().endNode, 1, x));
        }
        A &&
          (A = d.getPrevious()) &&
          A.type == CKEDITOR.NODE_ELEMENT &&
  ...
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (l in b) {
        ...
        for (g in W) {
          ...
          for (; (C = y.pop()); ) (G[C] = G["!" + C]), delete G["!" + C];
          p[t] = (B ? !1 : m) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === l.elements || null === l.elements)
          e[f ? "unshift" : "push"](l);
        else
          for (k in ((r = l.elements), delete l.elements, r))
            if (b[k]) b[k][f ? "unshift" : "push"](l);
            else b[k] = [l];
      }
    }
    function d(a, c, d, e) {
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var l = 0, f = c.length, r; l < f; ++l)
                  (r = c[l]), e[r] || (e[r] = a(r));
                a = !1;
              }
            else a = !1;
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        b = b.classes;
        if (a) {
          for (var d = !1, l = !0 === a, r = b.length; r--; )
            if (l || a(b[r])) b.splice(r, 1), (d = !0);
          a = d;
        } else a = !1;
    ...
    function k(a, b) {
      ...
      if ((e = a.requiredClasses))
        for (l = b.classes, c = 0; c < e.length; ++c)
          ...
          } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(l, d))
            return !1;
      return (
    ...
    function A(a, b, e, l) {
      ...
      if (l.doCallbacks && a.elementCallbacks) {
        a: {
          ...
          for (var v = 0, g = q.length, p; v < g; ++v)
            if ((p = q[v](b))) {
              q = p;
              break a;
            }
    ...
    function l(a, b, c) {
      ...
      if (y.$empty[d] || !a.children.length)
        ...
        if ("br" == b)
          ...
          b: {
            e = y[b];
            for (var l = 0, r = d.length, f; l < r; ++l)
              if (((f = d[l]), f.type == CKEDITOR.NODE_ELEMENT && !e[f.name])) {
                e = !1;
                break b;
              }
            e = !0;
            ...
            for (
              ...
              (f = d[--r]),
                ...
                (f.type == CKEDITOR.NODE_TEXT ||
                  (f.type == CKEDITOR.NODE_ELEMENT && y.$inline[f.name]))
                  ? (v ||
    ...
    function J(a, b) {
      ...
      for (l in d)
        if ("class" == l)
          for (
            c = d[l].split(/\s+/), r = a.classes.join("|");
            (v = c.pop());
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c, d) {
        ...
        var e = this,
          f = [],
          r = this.editor && this.editor.config.protectedSource,
          v,
          q = !1,
              ...
              a: {
                ...
                if (r)
                  for (p = 0; p < r.length; ++p)
                    if ((t = d.match(r[p])) && t[0].length == d.length) {
                      c = !0;
                      break a;
                    }
        ...
        for (; (p = a.pop()); )
          if (((c = p.el), c.parent))
            switch (((t = y[c.parent.name] || y.span), p.check)) {
              case "it":
      ...
      check: function (a, b, c) {
        ...
        if ("string" == typeof a) {
          ...
          (d = a.getDefinition()),
            ...
            e && !CKEDITOR.tools.isEmpty(e)
              ? ((e = v(e)), (r.style = CKEDITOR.tools.writeCssText(e, !0)))
              : (e = {}),
            (e = {
              name: d.element,
              attributes: r,
        ...
        var r = CKEDITOR.tools.clone(e),
          q = [],
          g;
        if (!1 !== b && (g = this._.transformations[e.name])) {
          for (d = 0; d < g.length; ++d) t(this, e, g[d]);
          x(e);
        }
        A(this, r, q, {
          doFilter: !0,
        ...
        b =
          0 < q.length
            ? !1
            : CKEDITOR.tools.objectCompare(e.attributes, r.attributes, !0)
            ? !0
            : !1;
      ...
      transform: function (a, b) {
        if ("string" == typeof b) a.name = b;
          ...
          for (l in e)
            if ("class" == l)
              for (
                c = a.classes.join("|"), f = e[l].split(/\s+/);
                (v = f.pop());
            ...
            a.call(
              ...
              function (a) {
                ...
                for (f in a) {
                  ...
                  if (!d[f]) {
                    if (k.icons)
                      for (var A = k.icons.split(","), F = A.length; F--; )
  ...
  (function () {
              ...
              : ((h = a.langCode.replace(/-.*/, "")),
                (h =
                  h != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, h)
                    ...
                    ? "en"
                    : k[0])),
            t.langEntries && t.langEntries[h]
              ? ((a.lang[l] = t.langEntries[h]), (h = null))
              : f.push(CKEDITOR.getUrl(t.path + "lang/" + h + ".js")));
          e.push(h);
          d.push(t);
        }
    ...
    function A(a, b) {
      ...
      for (
        ...
        var q = a[h],
          y = q.startContainer.getAscendant("tr", !0);
        c(q)
          ? (f ||
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (g, h, k) {
      ...
      function D(b, c, d) {
        ...
        var e = z;
        void 0 === b.previous &&
          (w(c, b) && ((z = c), F.onTagOpen(k, {}), (b.returnPoint = c = z)),
          f(b),
        ...
        if (a(f)) m.push(f);
          ...
          if ("br" == e) K.push(f);
            ...
            for (
              ...
              if (z.isOptionalClose) F.onTagClose(g);
        ...
        var b = z.name,
          f = b
            ? CKEDITOR.dtd[b] ||
              (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
            : c;
        if (!I && !f["#"] && b in d) F.onTagOpen(e[b] || ""), F.onText(a);
        else {
          u();
          n();
          l || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
      ...
      function v(a, d) {
        return function (e) {
          if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            ...
            if ((l = !a || !1 !== ("function" == typeof d ? d(e) : d)))
              y ||
              CKEDITOR.env.needsBrFiller ||
              e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? y ||
    ...
    function f(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf("\x3ctextarea") &&
          (a =
            b +
            A(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
            "\x3c/textarea\x3e");
        return (
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
      new CKEDITOR.htmlParser.node(),
      {
        ...
        filter: function (a, b) {
          ...
          for (n in h) {
            for (k = h[n]; ; )
              if ((u = a.onAttributeName(b, n)))
                if (u != n) delete h[n], (n = u);
                else break;
              else {
                delete h[n];
                break;
  ...
  (function () {
      ...
      proto: {
        ...
        setup: function () {
          ...
          if (!this.is("textarea")) {
            ...
            if (h) {
              var k = e.getHead(),
                q = k.getCustomData("stylesheet");
              q
                ? h != q.getText() &&
                  (CKEDITOR.env.ie && 9 > CKEDITOR.env.version
                    ? (q.$.styleSheet.cssText = h)
                    : q.setText(h))
                ...
                if (c in y) {
                  ...
                  (e = g(b))
                    ...
                    : q.collapsed &&
                      ...
                      k.is("table") &&
                      q[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          q[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            C.remove(),
                          q["moveToElementEdit" + (c ? "End" : "Start")](k),
                          q.select(),
                          a.fire("saveSnapshot"),
                          (d = 1))
                        : p.blockLimit &&
                          p.blockLimit.is("td") &&
                          (r = p.blockLimit.getAscendant("table")) &&
                          q.checkBoundaryOfElement(
                            r,
                            c ? CKEDITOR.START : CKEDITOR.END
                          ) &&
                          (k = r[c ? "getPrevious" : "getNext"](f))
                        ? (a.fire("saveSnapshot"),
                          q["moveToElementEdit" + (c ? "End" : "Start")](k),
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, "mouseup", function (b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()), !b.getOuterHtml().replace(F, ""))
                ) {
                  var c = a.createRange();
    ...
    x = (function () {
      ...
      return function (B, p, C, r) {
        ...
        if (!r.checkReadOnly()) {
          var P =
            new CKEDITOR.dom.elementPath(r.startContainer, r.root).blockLimit ||
            r.root;
          B = {
            type: p,
            dontFilter: N,
          ...
          m = p.startPath();
          if ((G = m.contains(f, !1, 1)))
            p.splitElement(G),
              (B.inlineStylesRoot = G),
          ...
          if ((m = C)) {
            ...
            if ("text" == B.type && B.inlineStylesRoot) {
              ...
              for (r = B.inlineStylesRoot.getParent(); !w.equals(r); )
            ...
            if (
              ...
              a: {
                ...
                if (
                  ...
                  m = 0;
                  for (r = D.count(); m < r; m++)
                    if (((p = D.getItem(m)), !p.is(u))) break a;
          ...
          if (m) {
            ...
            for (g(p, A); r < p.length; r++) {
              ...
              if ((M = P.isLineBreak)) {
                ...
                P.hasBlockSibling
                  ? (M = 1)
                  : (S = M.startContainer.getAscendant(v.$block, 1)) &&
                    S.is({ div: 1, p: 1 })
                  ? ((Z = S.getPosition(I)),
          ...
          for (X = z.createBookmark(); (F = B.zombies.pop()); )
            F.getParent() &&
              ((T = z.clone()),
              T.moveToElementEditStart(F),
              T.removeEmptyBlocksAtEnd());
          if (K)
            for (; (F = K.pop()); )
              CKEDITOR.env.needsBrFiller
                ? F.appendBogus()
                : F.append(z.document.createText(" "));
          for (; (F = B.mergeCandidates.pop()); ) F.mergeSiblings();
          z.moveToBookmark(X);
          if (!B.dontMoveCaret) {
            for (F = e(z); F && a(F) && !F.is(v.$empty); ) {
              if (F.isBlockBoundary())
                z.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
              else {
          ...
          h.attachListener(h, "mousedown", function (a) {
            2 == a.data.$.button &&
              (((a = c.document.getSelection()) &&
                ...
                (m = c.window.getScrollPosition()));
          });
          h.attachListener(h, "mouseup", function (a) {
            2 == a.data.$.button &&
              m &&
              ((c.document.$.documentElement.scrollLeft = m.x),
              (c.document.$.documentElement.scrollTop = m.y));
            m = null;
          });
        ...
        var a = x
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                for (; 0 < h; )
                  try {
                    (g = f[0 < n ? "previousSibling" : "nextSibling"]),
                      g.nodeType == CKEDITOR.NODE_TEXT &&
                        ((h -= g.nodeValue.length), (m = g)),
                      (f = g);
                  } catch (u) {
            ...
            if (l) this.fake(l);
              ...
              if (x) {
                ...
                k
                  ...
                  : ((r = C.getNext(p)),
                    (G = C.hasAscendant("pre")),
                    (r =
                      !(r && r.getText && r.getText().match(l)) &&
                      (G ||
                        !C.hasPrevious() ||
                    ...
                    G.setHtml("\x26#65279;"),
                    G.insertBefore(C),
                    r && d.document.createText("﻿").insertBefore(C));
                d.setStartBefore(C);
                C.remove();
                b
                  ? (r
                ...
                for (m = 0; m < b.length; m++) {
                  if (
                    ...
                    (G = b[m + 1]),
                    (l = r.clone()),
                    l.setStart(r.endContainer, r.endOffset),
                    l.setEnd(G.startContainer, G.startOffset),
                    !l.collapsed &&
                  ...
                  try {
                    ...
                    if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                      d.collapse(1), G.setEnd(d.endContainer.$, d.endOffset);
                    else throw t;
                  }
                  k.addRange(G);
                }
                ...
                if (
                  (v ||
                    (A &&
                      ...
                      (q.getPosition(t) | W) != W) ||
                    ((v = c.clone()), v.setStartBefore(q)),
                  (A = q.type),
                  A == CKEDITOR.NODE_TEXT ||
                    x ||
                    (A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()))
                ) {
                  for (
                    var A = q, L;
                    (l = !A.getNext(B)) &&
                    ((L = A.getParent()), n[L.getName()]) &&
                    d(L, w, h, O);
    ...
    function A(a, b) {
      ...
      for (g in d)
        if (
          ...
          a.getAttribute(g) == t(g, d[g])
        )
          (b && "data-" == g.slice(0, 5)) ||
            ((f = a.hasAttribute(g)), a.removeAttribute(g));
      for (var h in c)
        (this._.definition.fullMatch && a.getStyle(h) != t(h, c[h], !0)) ||
        ...
        return {
          getNextRange: function (h) {
            ...
            if (k && 1 < a.length) {
              ...
              for (k.moveToBookmark(d.shift()); u--; )
                (n = a[++g]),
...
*/
  ...
  (function () {
    ...
    function t(d, e) {
      for (
        var b = G(d) ? d : q(d),
          ...
          b = new CKEDITOR.dom.element(f.$.rows[k]),
          h = e ? h : k,
          a = e ? a : b,
          b = CKEDITOR.tools.buildTableMap(f),
          f = b[h],
          h = e ? b[h - 1] : b[h + 1],
          b = b[0].length,
        ...
        1 < f[k].rowSpan && h && f[k] == h[k]
          ? ((g = f[k]), (g.rowSpan += 1))
          : ((g = new CKEDITOR.dom.element(f[k]).clone()),
    ...
    function D(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        for (d = a; d <= h; d++) {
          for (
            var k = f[d], g = new CKEDITOR.dom.element(c.$.rows[d]), l = 0;
            l < k.length;
            l++
          ) {
            var r = new CKEDITOR.dom.element(k[l]),
              n = r.getParent().$.rowIndex;
            1 == r.$.rowSpan
              ? r.remove()
              : (--r.$.rowSpan,
                n == d &&
                  ((n = f[d + 1]),
                  n[l - 1]
                    ? r.insertAfter(new CKEDITOR.dom.element(n[l - 1]))
                    : new CKEDITOR.dom.element(c.$.rows[d + 1]).append(r, 1)));
            l += r.$.colSpan - 1;
          }
          b.push(g);
        }
        ...
        a = new CKEDITOR.dom.element(
          f[h + 1] || (0 < a ? f[a - 1] : null) || c.$.parentNode
        );
    ...
    function p(d, e) {
      for (
        var b = G(d) ? d : q(d),
          ...
          b = w(b),
          a = e ? f : b,
          h = CKEDITOR.tools.buildTableMap(c),
          c = [],
          f = [],
          b = [],
          k = h.length,
        ...
        c.push(h[g][a]), f.push(e ? h[g][a - 1] : h[g][a + 1]);
      for (g = 0; g < k; g++)
        c[g] &&
          (1 < c[g].colSpan && f[g] == c[g]
            ? ((h = c[g]), (h.colSpan += 1))
            : ((a = new CKEDITOR.dom.element(c[g])),
              (h = a.clone()),
              h.removeAttribute("colSpan"),
              h.appendBogus(),
              h[e ? "insertBefore" : "insertAfter"].call(h, a),
              b.push(h),
              (h = h.$)),
          (g += h.rowSpan - 1));
      return b;
    ...
    function v(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        a: {
          ...
          f = b.length - 1;
          for (var h = {}, k, g; (k = b[a++]); )
            CKEDITOR.dom.element.setMarker(h, k, "delete_cell", !0);
          for (a = 0; (k = b[a++]); )
            if (
        ...
        d instanceof CKEDITOR.dom.element &&
          ((e = d.getParent()),
          1 == e.getChildCount() ? e.remove() : d.remove());
    }
    function x(d, e) {
      var b = d.getDocument(),
        c = CKEDITOR.document;
      ...
      b["moveToElementEdit" + (e ? "End" : "Start")](d) ||
        (b.selectNodeContents(d), b.collapse(e ? !1 : !0));
      b.select(!0);
    }
    function y(d, e, b) {
      d = d[e];
    ...
    function z(d, e, b) {
      var c = q(d),
        f;
      if (
        (e ? 1 != c.length : 2 > c.length) ||
        ((f = d.getCommonAncestor()) &&
          f.type == CKEDITOR.NODE_ELEMENT &&
          f.is("table"))
      )
        return !1;
      ...
      if (e) {
        ...
        try {
          ...
          n =
            h["up" == e ? l - C : "down" == e ? l + C : l][
              "left" == e ? r - a : "right" == e ? r + a : r
            ];
        } catch (x) {
          return !1;
        }
        if (!n || d.$ == n) return !1;
        c["up" == e || "left" == e ? "unshift" : "push"](
      ...
      var E = l,
        C = (n = 0),
        u = !b && new CKEDITOR.dom.documentFragment(e),
        t = 0;
      for (e = 0; e < c.length; e++) {
        ...
        b ||
          ((m = a),
          (v = m.getBogus()) && v.remove(),
          m.trim(),
          a.getChildren().count() &&
            (p == E ||
              !w ||
              (w.isBlockBoundary && w.isBlockBoundary({ br: 1 })) ||
              ((E = u.getLast(CKEDITOR.dom.walker.whitespaces(!0))),
              !E || (E.is && E.is("br")) || u.append("br")),
            a.moveChildren(u)),
          e ? a.remove() : a.setHtml(""));
        E = p;
      }
      if (b) return n * C == t;
      u.moveChildren(d);
      ...
      n >= k ? d.removeAttribute("colSpan") : (d.$.colSpan = C);
      b = new CKEDITOR.dom.nodeList(f.$.rows);
      c = b.count();
      for (e = c - 1; 0 <= e; e--)
        (f = b.getItem(e)), f.$.cells.length || (f.remove(), c++);
      return d;
    }
    function A(d, e) {
      var b = q(d);
      ...
      var b = b[0],
        c = b.getParent(),
        f = c.getAscendant("table"),
        a = CKEDITOR.tools.buildTableMap(f),
        h = c.$.rowIndex,
        k = y(a, h, b),
        g = b.$.rowSpan,
        l;
      if (1 < g) {
        ...
        for (
          var g = Math.floor(g / 2),
            c = h + l,
            f = new CKEDITOR.dom.element(f.$.rows[c]),
            a = y(a, c),
            r,
            c = b.clone(),
            h = 0;
    ...
    function F(d, e) {
      ...
      var b = b[0],
        ...
        a = y(f, c.$.rowIndex, b),
        h = b.$.colSpan;
      if (1 < h) (c = Math.ceil(h / 2)), (h = Math.floor(h / 2));
      else {
        for (var h = (c = 1), k = [], g = 0; g < f.length; g++) {
          var l = f[g];
          k.push(l[a]);
                ...
                [
                  {
                    ...
                    right: function (a) {
                      a.styles["background-color"] = f.background(
                        a.styles.background
                      ).color;
                    },
                  },
          ...
          e({
            ...
            exec: function (a) {
              ...
              for (var m = 0, b = f.length; m < b; m++)
                for (var u = 0, v = f[m].length; u < v; u++)
                  f[m][u] == d.$ && (n = u), f[m][u] == e.$ && (p = u);
              for (m = n; m <= p; m++)
                for (u = 0; u < f.length; u++)
                  (e = f[u]),
                    (d = new CKEDITOR.dom.element(c.$.rows[u])),
                    (e = new CKEDITOR.dom.element(e[m])),
                    e.$ &&
                      (1 == e.$.colSpan ? e.remove() : --e.$.colSpan,
                      (u += e.$.rowSpan - 1),
                      d.$.cells.length || t.push(d));
              p = c.$.rows[0] && c.$.rows[0].cells;
              n = new CKEDITOR.dom.element(
                p[n] || (n ? p[n - 1] : c.$.parentNode)
              );
              t.length == b &&
                (a[0].moveToPosition(c, CKEDITOR.POSITION_AFTER_END),
                a[0].select(),
                c.remove());
              n && x(n, !0);
            },
            ...
            tablecell: {
              ...
              getItems: function () {
                ...
                return {
                  ...
                  tablecell_merge: z(a, null, !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_merge_right: z(a, "right", !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_merge_down: z(a, "down", !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_split_vertical: F(a, !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
  ...
  CKEDITOR.tools.buildTableMap = function (q, t, D, B, w) {
    ...
    for (t = t || 0; t <= B; t++) {
      ...
      for (
        ...
        for (v++; m[p][v]; ) v++;
        for (
          var z = isNaN(y.colSpan) ? 1 : y.colSpan,
            y = isNaN(y.rowSpan) ? 1 : y.rowSpan,
            A = 0;
          A < y && !(t + A > B);
          A++
        ) {
  ...
  (function () {
    function x(a, b) {
      ...
      for (c = k; c <= m; c++)
        for (k = f; k <= p; k++)
          (d = new CKEDITOR.dom.element(e[c][k])),
            d.$ &&
              !d.getCustomData("selected_cell") &&
              (l.push(d),
              CKEDITOR.dom.element.setMarker(h, d, "selected_cell", !0));
      CKEDITOR.dom.element.clearAllMarkers(h);
      return l;
    }
    function z(a) {
    ...
    function v(a) {
      ...
      function d(a, d, e, h) {
        return ("mousedown" === a.name && (z(a) || !h)) ||
          ("mouseup" === a.name && !c(a.data.getTarget()) && !b(e, h))
          ? !0
          : !1;
      }
      if (a.data.getTarget().getName) {
        var e = a.editor || a.listenerData.editor,
          ...
          m = I(e),
          l = a.data.getTarget(),
          h = l && l.getAscendant({ td: 1, th: 1 }, !0),
        ...
        (h || l) && K(e, h || l, a);
        "mouseup" === a.name &&
          (z(a) && (c(a.data.getTarget()) || b(m, l)) && J(e),
          (g = { active: !1 }),
    ...
    q.prototype.insertRow = function (a, b, c) {
      ...
      for (
        ...
        (m = E(c ? this.cells.all : k, b)),
          (m = CKEDITOR.tools.array.filter(
            m.find("td, th").toArray(),
            function (a) {
    ...
    q.prototype.insertColumn = function (a) {
      ...
      for (
        var c = this.cells, d = c.all, e = n(c.first), k = n(c.last), c = 0;
        c < a;
        c++
      )
        d = d.concat(CKEDITOR.tools.array.filter(F(d), b));
    ...
    var G = {
      onPaste: function (a) {
        ...
        var d = a.editor,
          ...
          f;
        !k.length ||
          (1 === k.length && !H(e.getRanges()[0]) && !l) ||
          (l && !m) ||
          ((k = k[0].getAscendant("table")),
          (h = new q(u(e, k))),
          ...
          m
            ? (a.stop(),
              l
                ? (h.insertRow(1, 1 === l, !0), e.selectElement(h.rows.first))
                : (h.emptyCells(), t(d, h.cells.all)),
              (a = h.getTableMap()),
              (f = CKEDITOR.tools.buildTableMap(m)),
              h.insertRow(f.length - a.length),
              h.insertColumn(b(f) - b(a)),
              (a = h.getTableMap()),
              this.pasteTable(h, a, f),
              d.fire("saveSnapshot"),
              setTimeout(function () {
                d.fire("afterPaste");
              }, 0))
      ...
      pasteTable: function (a, b, c) {
        ...
        for (f = 0; f < c.length; f++)
          for (
            l = new CKEDITOR.dom.element(k.$.rows[a.rows.first.$.rowIndex + f]),
              p = 0;
            p < c[f].length;
            p++
          )
            if (
              ((h = new CKEDITOR.dom.element(c[f][p])),
              (d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null),
              h && !h.getCustomData("processed"))
            ) {
              if (d && d.getParent()) h.replace(d);
                ...
                l.equals(d.getParent())
                  ...
                  : 0 < e
                  ? l.$.cells[e]
                    ? h.insertAfter(new CKEDITOR.dom.element(l.$.cells[e]))
                    : l.append(h)
                  : l.append(h, !0);
        ...
        c.attachListener(
          ...
          (function (a) {
            function c(b, e) {
              ...
              var f = a.createRange(),
                k = CKEDITOR.dom.range.mergeRanges(e);
              CKEDITOR.tools.array.forEach(k, function (a) {
                a.enlarge(CKEDITOR.ENLARGE_ELEMENT);
              });
              var r = k[0].getBoundaryNodes(),
                g = r.startNode,
                r = r.endNode;
              if (g && g.is && g.is(m)) {
                for (
            ...
            return function (l) {
              var h = l.data.getKey(),
                ...
                n,
                q;
              if (k[h] && (f = a.getSelection()) && f.isInTable() && f.isFake)
                if (
                  ((g = f.getRanges()),
        ...
        c.attachListener(
          ...
          function (d) {
            var c = a.getSelection(),
              k = d.data.$.charCode || 13 === d.data.getKey(),
              g;
            if (
              c &&
              c.isInTable() &&
              ...
              d = c.getRanges();
              k = d[0].getEnclosedNode().getAscendant({ td: 1, th: 1 }, !0);
        ...
        CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
          ...
          a.on("contentDom", function () {
            ...
            CKEDITOR.plugins.clipboard &&
              ...
              (b.attachListener(b, "cut", D), b.attachListener(b, "copy", D));
          }),
          a.on("paste", G.onPaste, G),
          A(
            a,
          ...
          [
            {
              ...
              right: function (b) {
                ...
                b.name = "span";
                b.attributes.size &&
                  ((b.styles["font-size"] = a[b.attributes.size]),
                  delete b.attributes.size);
                b.attributes.align &&
                  ((b.styles["text-align"] = b.attributes.align),
                  delete b.attributes.align);
                b.attributes.face &&
                  ((b.styles["font-family"] = b.attributes.face),
                  delete b.attributes.face);
              },
            },
          ],
        ],
          ...
          if (c && b != c) {
            ...
            if (f.collapsed) {
              ...
              if (k) {
                ...
                if (d && l) {
                  for (d = f.createBookmark(); (g = k.getFirst()); )
                    g.insertBefore(k);
                  k.remove();
                  f.moveToBookmark(d);
                } else
          ...
          a.on(
            ...
            function (b) {
              ...
              for (var d = 0, e; d < b.length; d++) {
                e = b[d];
                for (var f in m)
                  if (m[f].checkElementMatch(e, !0, a)) {
                    f != c && this.setValue(f);
                    return;
                  }
              }
  ...
  CKEDITOR.config.plugins =
    "dialogui,dialog,about,a11yhelp,basicstyles,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,resize,elementspath,enterkey,entities,popup,filebrowser,floatingspace,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,tab,table,tabletools,tableselection,undo,justify,print,listblock,richcombo,font,wsc,panelbutton,colorbutton";
  ...
  (function () {
    ...
    if (CKEDITOR.env.hidpi)
      setIcons(
        "about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,image,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,anchor-rtl,456,,anchor,480,,link,504,,unlink,528,,bulletedlist-rtl,552,,bulletedlist,576,,numberedlist-rtl,600,,numberedlist,624,,maximize,648,,pastetext-rtl,672,,pastetext,696,,pastefromword-rtl,720,,pastefromword,744,,removeformat,768,,source-rtl,792,,source,816,,specialchar,840,,scayt,864,,table,888,,redo-rtl,912,,redo,936,,undo-rtl,960,,undo,984,,justifyblock,1008,,justifycenter,1032,,justifyleft,1056,,justifyright,1080,,print,1104,,spellchecker,1128,,bgcolor,1152,,textcolor,1176,",
        "icons_hidpi.png"
      );
    else
      setIcons(
        "about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,image,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,anchor-rtl,456,auto,anchor,480,auto,link,504,auto,unlink,528,auto,bulletedlist-rtl,552,auto,bulletedlist,576,auto,numberedlist-rtl,600,auto,numberedlist,624,auto,maximize,648,auto,pastetext-rtl,672,auto,pastetext,696,auto,pastefromword-rtl,720,auto,pastefromword,744,auto,removeformat,768,auto,source-rtl,792,auto,source,816,auto,specialchar,840,auto,scayt,864,auto,table,888,auto,redo-rtl,912,auto,redo,936,auto,undo-rtl,960,auto,undo,984,auto,justifyblock,1008,auto,justifycenter,1032,auto,justifyleft,1056,auto,justifyright,1080,auto,print,1104,auto,spellchecker,1128,auto,bgcolor,1152,auto,textcolor,1176,auto",
        "icons.png"
      );
  })();
  CKEDITOR.lang.languages = { en: 1, ko: 1 };
})();
