$(function(){
	...
	$(".lang_en").click(function(){
		...
		if(pathname.includes('/util/privacy_statement') || pathname.includes('/util/billing_agreement') || pathname.includes('/util/eft_agreement') || pathname.includes('/util/pg_faq')
			|| pathname.includes('/sustainability/contribution/education_volunteers')) {
				
				pathname = '/';
		}
		
		if(pathname.includes('/news/press_release/detail/') || pathname.includes('/news/blog/detail/') || pathname.includes('/news/notice/detail/')) {
