...
<html lang="ko">
  <head>
    ...
    <script
      src="//rum.beusable.net/script/checker/b200701e124559u075/dc76114514?url=https%3A%2F%2Fwww.cjolivenetworks.co.kr%2F"
      async=""
        ...
        <div class="inner">
          ...
          <nav class="gnb-wrap">
            <ul>
              ...
              <li class="business_search">
                <a href="/business/our_services">서비스</a>
                <section class="sub sub-menu2">
                  <div class="sub-wrap">
                    <ul class="sub-2depth">
                      <li>
                        <a href="/business/ai_factory_solution" class="is_sub">Digital Twin - A.I XR</a>
                        <ul class="sub-3depth">
                          <li>
                            <a href="/business/ai_factory_solution">사업소개</a>
                          </li>
                          <li>
                            <a href="/business/ai_logistics">A.I 스마트 안전관리</a>
                          </li>
                          <li><a>Vision A.I</a></li>
                          <li><a>Smart BIM 건설통합관리</a></li>
                          <li><a>Smart 통합관제</a></li>
                          <li><a>컨설팅</a></li>
                        </ul>
                      </li>
                      <li>
                        <a href="/business/media_culture_spaces" class="is_sub">스마트 팩토리</a>
                        <ul class="sub-3depth">
                          <li><a>사업소개</a></li>
                          <li><a>SCM 구축</a></li>
                          <li><a>System Modeling</a></li>
                          <li><a>System I/F</a></li>
                          <li><a>PLM 구축</a></li>
                          <li><a>PMS</a></li>
                          <li><a>EAM/ESS</a></li>
                        </ul>
                      ...
                      <li>
                        <a href="/business/cj_one_ad" class="is_sub">스마트 비지니스</a>
                        <ul class="sub-3depth">
                          <li><a>사업소개</a></li>
                          <li><a>시스템 통합</a></li>
                          <li><a>시스템 운영</a></li>
                          <li><a>웹/앱 서비스</a></li>
                          <li><a>이커머스</a></li>
                          <li><a>IT Outsourcing</a></li>
                        </ul>
                      </li>
                      <li>
                        <a href="/business/smart_store_solution" class="is_sub">스마트 팜</a>
                        <ul class="sub-3depth">
                          <li><a>사업소개</a></li>
                          <li><a>육가공관리시스템</a></li>
                          <li><a>사료관리시스템</a></li>
                      ...
                      <li>
                        <a href="/business/system_integration" class="is_sub">플랫폼&솔루션</a>
                        <ul class="sub-3depth">
                          <li><a>LPA+</a></li>
                          <li><a>SDS PLM</a></li>
                          <li><a>육가공관리솔루션</a></li>
                      ...
                      <a href="/business/our_services" class="common-btn"><span>전체 서비스 보기</span>
                      <i class="icon link-arrow2"></i></a>
                    </ul>
                  </div>
                </section>
              </li>
              <li class="tech_search">
                <a href="/tech/rnd">기술</a>
              ...
              <li>
                <a href="/sustainability/compliance/ceo_practice">ESG</a>
                <section class="sub sub-menu5">
                  <div class="sub-wrap">
                    <ul class="sub-2depth">
                      ...
                      <li>
                        <a href="/sustainability/compliance/ai_ethics"
                          >AI윤리원칙</a
                        >
                      </li>
                      <li>
                        <a href="/sustainability/compliance/safetypolicy"
                          >안전 경영</a
                        >
                      </li>
                      <li>
                        <a
                          href="/sustainability/contribution/education"
                          class="is_sub"
                          >사회 공헌</a
                        >
                        <ul class="sub-3depth">
                          <li>
                            <a href="/sustainability/contribution/education"
                              >공평한 교육</a
                            >
                          </li>
                          <li>
                            <a href="/sustainability/contribution/economic"
                              >경제적 기회</a
                            >
                          </li>
                          <li>
                            <a href="/sustainability/contribution/welfare"
                              >건강한 복지</a
                            >
                          </li>
                        </ul>
              ...
              <li>
                <a href="/recruit/job_notice">채용</a>
                <section class="sub sub-menu7">
                  <div class="sub-wrap">
                    <ul class="sub-2depth">
          ...
          <div id="sitemap" aria-hidden="true">
            <div class="sitemap-body">
              <ul>
                ...
                <li>
                  <a href="/business/our_services" class="btn_submenu"
                    >서비스</a
                  >
                  <div class="sub-wrap sub-sitemap2">
                    <ul class="sub-2depth">
                      <li class="show_1280">
                        <a href="/business/our_services" class="btn_all_service"
                          >전체 서비스 보기</a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <ul class="sub-3depth">
                          ...
                          <li><a href="/business/nft">NFT</a></li>
                          <li>
                          ...
                          <li>
                            <a href="/business/music_service"
                              >공간 음악 서비스</a
                            >
                          </li>
                          <li>
                            <a href="/business/media_Infra"
                              >방송•미디어 통합 인프라 솔루션</a
                            >
                          </li>
                        </ul>
                      ...
                      <li>
                        <a href="/business/cj_one_ad" class="btn_submenu"
                          >디지털 마케팅</a
                        >
                        <ul class="sub-3depth">
                          <li><a href="/business/cj_one_ad">CJ ONE AD</a></li>
                          <li>
                            <a href="/business/cj_gift_card">CJ기프트카드</a>
                          </li>
                          <li>
                            <a href="/business/mobile_marketing_automation"
                              >데이터 마케팅 솔루션</a
                            >
                          </li>
                          <li>
                      ...
                      <li>
                        ...
                        <ul class="sub-3depth">
                          ...
                          <li>
                            <a href="/business/ticket_reservation"
                              >티켓 통합 솔루션</a
                            >
                          </li>
                          <li>
                            <a href="/business/payment_gateway_security"
                              >결제 솔루션</a
                            >
                          </li>
                        </ul>
                      ...
                      <li>
                        <a
                          href="/business/system_integration"
                          class="btn_submenu"
                          >스마트 비즈니스</a
                        >
                        <ul class="sub-3depth">
                          <li>
                            <a href="/business/system_integration"
                              >시스템 통합</a
                            >
                          </li>
                          <li>
                            <a href="/business/system_management"
                              >시스템 운영</a
                            >
                          </li>
                          <li>
                      ...
                      <li>
                        <a href="/business/ai_infra" class="btn_submenu"
                          >클라우드&인프라</a
                        >
                        <ul class="sub-3depth">
                          <li>
                            <a href="/business/ai_infra"
                              >AI 통합 인프라 솔루션</a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="/business/cloud_service"
                              >Hybrid/Multi 클라우드 서비스</a
                            >
                          </li>
                        </ul>
                      </li>
                      <li>
                        <a href="/business/cloud_security" class="btn_submenu"
                          >정보 보호</a
                        >
                        <ul class="sub-3depth">
                          <li>
                            <a href="/business/cloud_security"
                              >퍼블릭 클라우드 보안</a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="/business/ot_ics_security"
                              >산업제어시스템(OT/ICS) 보안</a
                            >
                          </li>
                        </ul>
                ...
                <li>
                  <a
                    href="/sustainability/compliance/ceo_practice"
                    class="btn_submenu"
                    >ESG</a
                  >
                  <div class="sub-wrap">
            ...
            <div class="sitemap-util">
              <!-- #수정 2022-05-26 오픈 전 다국어 숨김 시작 -->
              <ul>
                <li><a href="#" class="active lang_ko">KOR</a></li>
                <li><a href="#" class="lang_en">ENG</a></li>
              </ul>
              <!-- #수정 2022-05-26 오픈 전 다국어 숨김 끝 -->
              <p class="txt">
                CJ올리브네트웍스와 함께 <br />비즈니스의 변화와 혁신을
                시작하세요
              </p>
              <div class="btn_wrap">
                <a
                  ...
                  title="새 창 열림"
                  class="common-btn"
                  ><span>브로슈어</span><i class="icon link-download2"></i
                ></a>
                <a href="/util/contact_us" class="common-btn"
                  ><span>고객센터</span><i class="icon link-arrow2"></i
                ></a>
              </div>
              <p class="copy">© CJ Olivenetworks.</p>
            </div>
          </div>
                ...
                <a href="javascript:void(0)" class="btn_language">
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      ...
                      <path
                        d="m9.5 15.992-3.5.002c.168-4.614 3.78-8.671 8-9.607-2.722 1.9-4.353 5.906-4.5 9.605zm0 1.016L6 17.006c.168 4.614 3.78 8.671 8 9.607-2.722-1.9-4.353-5.906-4.5-9.605zm13 0 3.5-.002c-.168 4.614-3.78 8.671-8 9.607 2.722-1.9 4.353-5.906 4.5-9.605zm0-1.016 3.5.002c-.168-4.614-3.78-8.671-8-9.607 2.722 1.9 4.353 5.906 4.5 9.605zm-6 .002V6.39c2.788 1.659 4.819 5.575 4.996 9.605H16.5zm0 10.617v-9.605h5c-.19 3.82-2.257 7.801-5 9.605zm-1.005-9.605v9.605c-2.74-1.803-4.804-5.785-4.995-9.605h4.995zm.001-10.617v9.605H10.5c.177-4.03 2.208-7.946 4.996-9.605zM5 16.499c0 6.134 4.935 11.123 11 11.123 6.066 0 11-4.99 11-11.122 0-6.133-4.934-11.122-11-11.122-6.065 0-11 4.99-11 11.122z"
                        fill="#000"
                      ></path>
                    </g>
                  </svg>
      ...
      <div id="search-layer">
        <div class="inner">
          <div class="area_search">
            <form
              autocomplete="off"
              action="/searchall/search_results"
              method="post"
            >
              <input
                type="search"
      ...
      <section id="container">
        <div id="contents">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div class="inner">
                    <div
                      class="visual_txt_area aos-init aos-animate"
                      data-aos="fade-up"
                      data-aos-offset="0"
                    ...
                    >
                      <div class="main-banner">
                        ...
                        <p class="description">
                          1억 2천만 회원 데이터로 <br />정교한 타켓 맞춤 광고
                          집행이 가능합니다.
                        </p>
                      </div>
                      <div class="btn-area">
                        <a
                          ...
                          class="common-btn is-white2"
                          ><span>뉴스 보기</span><i class="icon link-arrow"></i
                        ></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="inner">
                    ...
                    >
                      <div class="main-banner">
                        ...
                        <p class="description">
                          산업 현장의 중대재해 예방과 작업자의 안전 보건을 통해
                          <br />ESG경영을 지원합니다.
                        </p>
                      </div>
                      <div class="btn-area">
                ...
                >
                  ...
                  <div class="inner">
                    ...
                    >
                      <div class="main-banner">
                        <h2 class="tit-slide">
                          AI 아트워크 플랫폼 에어트(AiRT) 기술로 <br />예술작품
                          NFT발행
                        </h2>
                        <p class="description">
                          AI 디지털아트 류재춘 화백 에디션 완판을 시작으로
                          <br />K-콘텐츠 NFT확산에 나섭니다.
                        </p>
                      </div>
                      <div class="btn-area">
                        <a
                          href="https://www.cjolivenetworks.co.kr/business/nft"
                          class="common-btn is-white2"
                          ><span>서비스 보기</span
                ...
                >
                  ...
                  <div class="inner">
                    ...
                    >
                      <div class="main-banner">
                        <h2 class="tit-slide">
                          시각장애인을 위한 화면 해설 방송에 <br />'AI 보이스
                          클로닝' 기술 적용
                        </h2>
                        <p class="description">
                          텍스트를 입력하면 음성을 자동으로 생성해주는 AI기술로
                          <br />시각장애인이 다양한 콘텐츠를 유명인의
                          내레이션으로 즐기게 되었습니다.
                        </p>
                      </div>
                      <div class="btn-area">
                        <a
                          href="https://www.cjolivenetworks.co.kr/tech/ai_audio"
                          class="common-btn is-white2"
                          ><span>기술 보기</span><i class="icon link-arrow"></i
                        ></a>
                        <a
          ...
          <div class="sub-visual section">
            ...
            <div class="ai-human-wrap">
              <div class="inner_container">
                <a href="/tech/ai_vision">
                  <h3
                    class="tit aos-init"
                    data-aos="fade-up"
                    data-aos-offset="200"
                  ...
                  <p
                    ...
                    data-aos-easing="linear"
                  >
                    가상 얼굴 생성과 영상 합성 기반의 AI 기술로<br />
                    시공간 제약을 뛰어넘어 메타버스 세계에서 자유롭게<br />
                    활동하는 ONLYONE 가상 인간을 제작합니다.
                  </p>
                </a>
                <div
                  ...
                  data-aos-easing="linear"
                >
                  <a href="/tech/ai_vision" class="common-btn is-white"
                    ><span>기술 알아보기</span><i class="icon link-arrow2"></i
                  ></a>
                </div>
              </div>
              <div class="responsive-area ready">
