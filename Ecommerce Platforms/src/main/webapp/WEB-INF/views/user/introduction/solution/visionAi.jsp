                ...
                <div class="layout_section_outer intro type01" data-js="anchor-target">
                    <div class="inner_container">
                        <div class="layout_head">
                            <p class="top_txt1">
                                Vision AI는 얼굴 이미지 탐지 후 등록 사진과 비교, 식별하여 출입관리, 
                                <br>신용인증 등의 서비스를 제공하는 AI 기반의 얼굴인식 영상처리/분석 플랫폼 솔루션을 소개합니다
                            </p>
                            <p class="top_txt3">
                                1. 객체 인식 및 분석 인공지능 서비스 제공 : 딥러닝 기반으로 사전 학습한 빅데이터를 기반으로 사물의 종류와 위치 등을 파악<br>
                                   산업현장 관련 객체가 미리 학습되어 있어 비즈니스에 바로 접목이 가능합니다.
                                2. 이미지 분류 : 이미지에 라벨을 할당하고 사전 정의된 수백만 개의 카테고리로 빠르게 분류할 수 있습니다.<br>
                                3. 사고예방 : 산업현장을 카메라를 통해 상황을 분석하고, 그 결과를 데이터 화여 작업자의 안전 및 진행상황을 파악할 수 있다.<br>
                                <br><br>
                                ※ Vision AI란<br>
                                Vision AI는 얼굴 이미지 탐지 후 등록 사진과 비교, 식별하여 출입관리, 
                                신용인증 등의 서비스를 제공하는 AI 기반의 얼굴인식 영상처리/분석 플랫폼 솔루션입니다. 
                                높은 인식률과 정확도는 물론, 블록체인 기반의 강력한 보안성도 제공하여 출입관리 뿐만 아니라 
                                신용인증, 안전관리 등 다양한 분야 서비스로 확장이 가능합니다.
                            </p>
                        </div>

                        <div class="layout_body">
                            <div class="common-img_box no-round">
                                <img src="${pageContext.request.contextPath}/resources/user/images/introduction/visionai_1.jpg" alt="">
                            </div>
                        </div>
                    </div>
