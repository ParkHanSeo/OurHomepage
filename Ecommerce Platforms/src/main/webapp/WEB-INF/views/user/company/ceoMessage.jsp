...
<meta property="og:title" content="회사소개 | CEO메시지 | 내담씨앤씨">
<meta name="description" content="내담씨앤씨 CEO 메시지입니다.">
<meta property="og:description" content="내담씨앤씨 CEO 메시지입니다.">
<meta name="keywords" content="내담C&C, 내담씨앤씨, ndcnc, 내담, NDCNC, 한창엽 대표, 한창엽">
<meta property="og:url" content="http://ndcc.co.kr/user/company/ceoList">
	...
	<section id="container">
		<div id="contents" class="contents_top ceofooter">
			...
			<div class="ceo_msg-box_media">
				...
				<p class="ceo_msg-txt2 line-03" style="margin: 20 0 0px;">
					<strong>내담은 혁신적인 서비스와 비즈니스로 감동을 선사합니다.</strong> <br> 고객과 제휴사를
					최우선으로 하여 믿음과 신뢰를 더하는 차별화된 서비스를 제공하고 있습니다
				</p>
				<p class="ceo_msg-txt2 line-03" style="margin: 20 0 0px;">
					<strong>내담은 성장하고자 하는 마음에 진심으로 응답합니다.</strong> <br> 다양한 꿈과 열정을
