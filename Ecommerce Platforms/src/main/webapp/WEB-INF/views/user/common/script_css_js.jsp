...
@font-face {
  ...
  src: url("${pageContext.request.contextPath}/resources/user/font/NanumGothic.woff") format("opentype");
}
body {
	font-family: "NanumGothic";
}
...
<!-- ND css -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/user/css/aos.css">
