            ...
            <div class="nft-wrap section">
               <div class="inner_container">
                  <h3 class="tit aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                     Improve client satisfaction and internal competitiveness
                  </h3>
                  <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                     Naedam C&C aims to upgrade client satisfaction and internal competitiveness to the next level
                     <br />based on accumulated experience and know-how, specialized technology and solutions. 
               ...
               <div class="core-wrap section">
                  <div class="inner_container">
                     <div class="section-title-area">
                        <h2 class="tit aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">Major Business</h2>
                        <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                           Naedam C&C provides the best system for your successful business at a time When competitiveness is 
                           needed such as Eco-Friendly, Fourth Industrial Revolution, Digital Transformation, AI, Cloud, and Digital Twin, and so on.
                        </p>
                     </div>
                     <ul class="core-list">
                        <li class="ai aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                           ...
                           <div class="main_aos_naedam_txt">
                              <h3 class="tit aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">If you with Naedam C&C</h3>
                              <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                                 Digital Twin, Vison AI, SI,
                                 <br />SCM(Supply Chain Management), 
                                 <br />PLM(Product Lifecycle Management), CRM, MES, 
                                 <br />EIP(Enterprise Information Portal), and so on 
                                 <br />Based on our deployment experience in various IT areas, 
                                 		we provide a variety of solutions and services for our clients.
                              </p>
                           </div>                           
                        </li>
                        <li class="big-data aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                           ...
                           <div class="main_aos_consulting_txt">
                              <h3 class="tit aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">Consulting</h3>
                              <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                                 We take the lead in strengthening the data ecosystem<br /> by adding our big data analysis capabilities and solution competitiveness.
                              </p>
                           </div>                           
                        </li>
                        <li class="blockchain aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                           ...
                           <div class="main_aos_si_txt">
                              <h3 class="tit aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                                 System Integration(integration of information systems)</h3>
                              <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                                 Naedam C&C provides total IT services for clients, including consulting and Application development/operation services, 
                  ...
                  <div class="inner_container">
                     <div class="section-title-area">
                        <div>
                           ...
                           <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                              It provides various services with Naedam C&C's technical skills.
                           </p>
                        </div>
                        <div class="btn-area aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
               ...
               <div class="inner_container">
                  <div class="section-title-area">
                     <div>
                        ...
                        <p class="description aos-init" data-aos="fade-up" data-aos-offset="0" data-aos-duration="250" data-aos-easing="linear">
                           We are waiting for you to create a new future with Naedam C&C
                        </p>
                     </div>
                  </div>
