                                ...
                                <ul class="esg_program_list">
                                    <li>
                                        <div class="esg_program_img">
                                        	<%-- <img src="${pageContext.request.contextPath}/resources/user/images/partner/partnership/partnerShipList_1.jpg" alt=""> --%>
                                    ...
                                    <li class="is-right">
                                        <div class="esg_program_img">
                                        	...
                                        	<%-- <img src="${pageContext.request.contextPath}/resources/user/images/partner/partnership/partnerShipList_2.jpg" alt=""> --%>
                                        </div>
                                        <div class="esg_program_desc">
                                    ...
                                    <li>
                                        <div class="esg_program_img">
                                            ...
                                            <%-- <img src="${pageContext.request.contextPath}/resources/user/images/partner/partnership/partnerShipList_3.jpg" alt=""> --%>
                                        </div>
                                        <div class="esg_program_desc">
